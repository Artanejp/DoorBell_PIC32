...
${OBJECTDIR}/_ext/203572575/sys_command.o: ../../../../microchip/harmony/v2_04/framework/system/command/src/sys_command.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/203572575" 
	@${RM} ${OBJECTDIR}/_ext/203572575/sys_command.o.d 
	@${RM} ${OBJECTDIR}/_ext/203572575/sys_command.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/203572575/sys_command.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -O1 -I"../src" -I"../src/system_config/default" -I"../src/default" -I"../../../../microchip/harmony/v2_04/framework" -I"../src/system_config/default/framework" -I"../../../../microchip/harmony/v2_04/framework/math/libq" -MMD -MF "${OBJECTDIR}/_ext/203572575/sys_command.o.d" -o ${OBJECTDIR}/_ext/203572575/sys_command.o ../../../../microchip/harmony/v2_04/framework/system/command/src/sys_command.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
