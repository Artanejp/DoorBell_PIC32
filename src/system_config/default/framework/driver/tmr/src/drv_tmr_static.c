...
{   
    ...
    /* Select prescalar value */
    PLIB_TMR_PrescaleSelect(TMR_ID_3, TMR_PRESCALE_VALUE_2);
    /* Enable 16 bit mode */
    PLIB_TMR_Mode16BitEnable(TMR_ID_3);
    /* Clear counter */ 
    PLIB_TMR_Counter16BitClear(TMR_ID_3);
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_3, 375);
    /* Setup Interrupt */   
...
{   
    ...
    /* Select clock source */
    PLIB_TMR_ClockSourceSelect ( TMR_ID_2, TMR_CLOCK_SOURCE_EXTERNAL_INPUT_PIN);
    /* Select prescalar value */
    ...
    /*Set period */ 
    PLIB_TMR_Period16BitSet(TMR_ID_2, 32768);
    /* Setup Interrupt */   
